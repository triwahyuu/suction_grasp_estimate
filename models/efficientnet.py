...
GlobalParams = collections.namedtuple('GlobalParams', [
    ...
    'depth_divisor', 'min_depth', 'drop_connect_rate', 'in_size'])
...
def get_model_params(model_name, override_params):
    ...
    if model_name.startswith('efficientnet'):
        w, d, res, p = efficientnet_params(model_name)
    ...
    return blocks_args, global_params, res
...
def load_pretrained_weights(model_name):
    ...
    return model_zoo.load_url(url_map[model_name])


def _check_model_name_is_valid(model_name, also_need_pretrained_weights=False):
...
def efficientnet(model_name, pretrained=False, override_params=None):
    """Constructs EfficientNet model.
    Args:
